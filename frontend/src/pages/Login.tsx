  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-950 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col lg:flex-row">
        ...
        <div
          ref={heroRef}
          className="w-full lg:w-1/2 flex flex-col justify-center px-6 sm:px-8 xl:px-16 py-6 lg:py-0 order-2 lg:order-1"
        >
              ...
              <div className="relative bg-slate-900/90 backdrop-blur-2xl rounded-3xl border border-blue-500/20 p-6 sm:p-8 lg:p-10 shadow-2xl shadow-blue-900/20">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="group relative w-full overflow-hidden bg-gradient-to-r from-blue-500 via-cyan-500 to-indigo-500 hover:from-blue-600 hover:via-cyan-600 hover:to-indigo-600 transition-all duration-500 py-4 rounded-2xl font-bold text-white shadow-2xl shadow-blue-500/30 hover:shadow-cyan-500/40 hover:scale-[1.02] disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100"
                  >
